 ...
 *
 * ↓ YOUR CODE HERE ↓ */
const myFoodChoice = "Cheddar Cheese Burger and Fries";
// const myDrinkChoice = "Arnold Palmer Ice Tea"; original line of code for Q1 commented out for Q2a
let myDrinkChoice = "Arnold Palmer Ice Tea for q2a"; //new code for q2a requirement

let myName = "Bob Ruzga";
let myFriendsName = "Jimmy VP";
...
/* console.log(`${myName}
                  ...
                  ${myFoodChoice}
                  ${myDrinkChoice}`)
    This console was to test my code above */              
//Question: Name a reason why you would use const instead of let.
//Answer: 
   console.log("const should be used when its a value/variable that will remain constant");
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
console.log(`${myName} and my friend 
               ${myFriendsName}
   will be eating
   ${myFoodChoice} and drinking 
   ${myDrinkChoice}`)
...
//Answer:
console.log("Using concatenation would require the new line, spacing, and formating to achieve what the template literals achieve /n" );
console.log(myName + " and my friend \n"  + "  " + myFriendsName +"\n will be eating \n" + myFoodChoice + " and drinking \n" + myDrinkChoice);
 ...
 *
 * ↓ YOUR CODE HERE ↓ */
myDrinkChoice = "Coke Zero";
console.log (myDrinkChoice);


//Question: Read the error message - in your own words - what does it mean?
//Answer:
console.log("Error is indicating that I'm trying to change a variable which I had defined originally as a constant");
